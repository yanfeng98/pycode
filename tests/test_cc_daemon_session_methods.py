"""Tests for cc_daemon/session_methods.py (RFC 0002 F-6 Phase 2).
...
The event bus is a real :class:`cc_daemon.events.EventBus` instance —
...
def _build_registry():
    ...
    from cc_daemon import session_methods
    reg = RpcRegistry()
