"""Tests for cc_daemon/runner_supervisor.py (RFC 0002 F-4 skeleton).
...
class TestIpcShim(unittest.TestCase):
    ...
    def test_reexports_match_kernel(self):
        from cc_daemon import runner_ipc
...
class TestSqlitePersistence(unittest.TestCase):
    ...
    def test_db_failure_does_not_raise(self):
        ...
        with patch("cc_daemon.schema.get_conn", side_effect=_raising_get_conn):
