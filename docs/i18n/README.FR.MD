...
> ⚠️ Cette traduction peut être obsolète. Pour la version la plus récente et exacte, consultez le [README](../../README.md) en anglais.
...
<div align=center>
<center style="color:#000000;text-decoration:underline">Exécution des tâches</center>
 </div>
...
<div align=center>
<center style="color:#000000;text-decoration:underline">Mode Brainstorm : brainstorming multi-agents</center>
 </div>
...
<div align=center>
<center style="color:#000000;text-decoration:underline">Mode proactif : agent autonome</center>
 </div>
...
<div align=center>
<center style="color:#000000;text-decoration:underline">Mode développeur SSJ : flux de travail via menu avancé</center>
 </div>
...
<div align=center>
<center style="color:#000000;text-decoration:underline">Passerelle Telegram : contrôlez CheetahClaws depuis votre téléphone</center>
 </div>
...
CheetahClaws : une réimplémentation Python de Claude Code, **légère** et **facile à utiliser**, avec **prise en charge de pratiquement tous les modèles**, notamment Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek, MiniMax, ainsi que des modèles open source locaux via Ollama ou tout endpoint compatible OpenAI.
...
**CheetahClaws** réimplémente la même boucle centrale dans un Python lisible : léger, modifiable, multi-fournisseur et exécutable localement. Il conserve l’essentiel et supprime la complexité inutile. Voir ici pour plus de détails : [English version](../comparison_claude_code_vs_nano_v3.03_en.md) and [Chinese version](../comparison_claude_code_vs_nano_v3.03_cn.md)
...
|-----------|----------------------|---------------------|
| Langage | TypeScript + Node.js | Python 3.8+ |
...
### Qui devrait utiliser CheetahClaws
...
| Fournisseur | Modèle | Contexte | Points forts | Variable d’environnement API |
|---|---|---|---|---|
...
| Modèle | Taille | Points forts | Commande pull |
|---|---|---|---|
...
## Surveillance proactive en arrière-plan
